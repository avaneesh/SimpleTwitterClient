 ...
 */
public class FragmentHomeTimeline extends FragmentTimeline {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        tweetModelResponse.setRequireLocalCache(true);
    }

    @Override
    public void fetchTimeline() {

        tw_client.getHomeTimeline(new JsonHttpResponseHandler(){
            @Override
